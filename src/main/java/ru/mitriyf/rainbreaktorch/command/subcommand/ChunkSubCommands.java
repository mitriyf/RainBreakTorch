package ru.mitriyf.rainbreaktorch.command.subcommand;
...
public class ChunkSubCommands {
    ...
    private void processChunk(World world, Chunk chunk, int minHeight, int maxHeight, AtomicInteger found, AtomicInteger currentChunks) {
        ...
        scheduler.runTaskAsynchronously(plugin, () -> {
            try {
                torchService.checkChunk(world, snapshot, minHeight, maxHeight, isStorm, found);
            } catch (Exception e) {
                logger.warning("Error chunk: " + e);
            } finally {
